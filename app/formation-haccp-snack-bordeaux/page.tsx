...
export const metadata: Metadata = {
  title: "Formation HACCP Snack à Bordeaux — Hygiène Alimentaire 2026",
  description: "Formation hygiène alimentaire pour snacks et restauration rapide à Bordeaux. 14h, attestation DRAAF, financement OPCO. Devis gratuit sous 24h.",
  alternates: { canonical: `${SITE_URL}/formation-haccp-snack-bordeaux` }
}

const FAQ = [
  { question: "La formation HACCP est-elle obligatoire pour les snacks et restauration rapide à Bordeaux ?", answer: "Oui, tous les établissements de type Snack (code NAF 56.10C) à Bordeaux sont soumis à l&apos;obligation de former au minimum un salarié à l&apos;hygiène alimentaire (14h). Cette obligation est en vigueur depuis octobre 2012." },
  { question: "Combien coûte la formation HACCP Snack à Bordeaux ?", answer: "Le tarif varie entre 290€ et 490€ TTC en présentiel à Bordeaux. La formation peut être prise en charge à 100% par l&apos;OPCO AKTO pour les salariés du secteur ou par France Travail pour les demandeurs d&apos;emploi." },
  ...
  { question: "Peut-on suivre la formation HACCP Snack en ligne depuis Bordeaux ?", answer: "Certains organismes proposent des formations à distance. Cependant, depuis 2024, 4 heures de mise en pratique sont obligatoires. Des formules mixtes (e-learning + présentiel) existent à Bordeaux." },
]
  ...
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(schemaBreadcrumb([
        ...
        { name: "Formation HACCP Snack Bordeaux", url: "/formation-haccp-snack-bordeaux" }
      ])) }} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(schemaCourse({
        name: "Formation HACCP Snack à Bordeaux",
        description: "Formation hygiène alimentaire spécifique Restauration rapide à Bordeaux",
        city: "Bordeaux",
        price: "290",
        duration: "PT14H"
      })) }} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(schemaLocalBusiness({
        name: "Formation HACCP Snack Bordeaux",
        city: "Bordeaux",
        postalCode: "33000",
        lat: 44.8378,
        lng: -0.5792
      ...
      <nav className="max-w-7xl mx-auto px-4 py-3 text-sm text-gray-500">
        <ol className="flex items-center gap-2 flex-wrap">
          ...
          <li>›</li>
          <li className="text-gray-800 font-medium">Snack à Bordeaux</li>
        </ol>
      </nav>
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h1 className="text-3xl lg:text-4xl font-extrabold leading-tight mb-4">
              Formation HACCP<br />
              <span className="text-yellow-400">Snack à Bordeaux</span><br />
            ...
            <p className="text-blue-100 text-base mb-5 leading-relaxed">
              Bordeaux, métropole viticole classée UNESCO, impose à tous les snacks et restauration rapide de former au moins un salarié à l&apos;hygiène alimentaire. Trouvez la meilleure formation HACCP Snack près de chez vous.
            </p>
          ...
          <div><LeadForm sector="snack" city="Bordeaux" title="Devis gratuit — Snack Bordeaux" /></div>
        </div>
      </section>

      <section className="py-12 px-4 bg-white">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl font-bold mb-6">Formation HACCP Snack à Bordeaux — Ce que la loi impose</h2>
          <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-5 mb-8">
            <p className="text-yellow-900 font-medium">
              📋 <strong>Obligation légale :</strong> Tout établissement de type Restauration rapide (code NAF 56.10C) à Bordeaux doit justifier d&apos;au minimum un salarié ayant suivi la formation spécifique en matière d&apos;hygiène alimentaire de 14 heures.
            </p>
          </div>
          <div className="prose prose-gray max-w-none text-gray-700 leading-relaxed space-y-4">
            <p>À <strong>Bordeaux</strong>, les snacks et restauration rapide sont soumis à l&apos;obligation de formation en hygiène alimentaire depuis le décret du 24 juin 2011. Cette formation, communément appelée « formation HACCP », dure <strong>14 heures</strong> et doit être dispensée par un organisme agréé par la DRAAF. Elle comprend désormais <strong>4 heures de mise en pratique obligatoire</strong> depuis l&apos;arrêté du 12 février 2024.</p>
      ...
      <section className="py-12 px-4 bg-gray-50">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-2xl font-bold mb-8">Questions fréquentes — HACCP Snack à Bordeaux</h2>
      ...
      <section className="py-12 px-4 bg-blue-700 text-white text-center">
        <div className="max-w-xl mx-auto">
          <h2 className="text-2xl font-bold mb-3">Formation HACCP Snack à Bordeaux</h2>
