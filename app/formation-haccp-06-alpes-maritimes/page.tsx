...
export const metadata: Metadata = {
  title: "Formation HACCP Alpes-Maritimes (06) — Hygiène Alimentaire Obligatoire 2026",
  description: "Formation hygiène alimentaire HACCP dans le Alpes-Maritimes (06). Organismes certifiés DRAAF, 14h, attestation officielle. Financement OPCO disponible. Devis gratuit.",
  alternates: { canonical: `${SITE_URL}/formation-haccp-06-alpes-maritimes` }
}

const FAQ = [
  { question: "La formation HACCP est-elle obligatoire dans le Alpes-Maritimes (06) ?", answer: "Oui, tous les établissements de restauration commerciale du département Alpes-Maritimes (06) sont soumis à l&apos;obligation de former au minimum un salarié à l&apos;hygiène alimentaire. Cette formation de 14 heures est obligatoire depuis octobre 2012." },
  { question: "Combien coûte une formation HACCP dans le Alpes-Maritimes ?", answer: "Le tarif varie entre 290€ et 490€ TTC en présentiel. La formation peut être prise en charge à 100% par l&apos;OPCO AKTO pour les salariés du secteur CHR ou par France Travail pour les demandeurs d&apos;emploi." },
  ...
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(schemaBreadcrumb([
        ...
        { name: "Formation HACCP Alpes-Maritimes (06)", url: "/formation-haccp-06-alpes-maritimes" }
      ])) }} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(schemaCourse({
        name: "Formation Hygiène Alimentaire HACCP — Alpes-Maritimes (06)",
        description: "Formation HACCP adaptée à la restauration commerciale dans le département Alpes-Maritimes",
        city: "Nice",
        price: "290",
        duration: "PT14H"
      })) }} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(schemaLocalBusiness({
        name: "Formation HACCP Alpes-Maritimes",
        city: "Nice",
        postalCode: "06000",
        lat: 43.7102,
        lng: 7.262
      ...
      <nav className="max-w-7xl mx-auto px-4 py-3 text-sm text-gray-500">
        <ol className="flex items-center gap-2 flex-wrap">
          ...
          <li>›</li>
          <li className="text-gray-800 font-medium">Formation HACCP Alpes-Maritimes (06)</li>
        </ol>
      </nav>
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div>
            <div className="inline-flex items-center gap-2 bg-blue-600/40 text-sm px-3 py-1 rounded-full mb-4">
              📍 Alpes-Maritimes (06) — PACA
            </div>
            <h1 className="text-3xl lg:text-4xl font-extrabold leading-tight mb-4">
              Formation HACCP<br />
              <span className="text-yellow-400">Alpes-Maritimes (06)</span><br />
          ...
          <div>
            <LeadForm city="Nice" title="Devis gratuit — Alpes-Maritimes (06)" />
          </div>
        </div>
      </section>
      ...
      <section className="py-12 px-4 bg-white">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl font-bold mb-6">Formation hygiène alimentaire dans le Alpes-Maritimes — Tout savoir</h2>
          <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-5 mb-8">
            <p className="text-yellow-900 font-medium">
              📋 <strong>Obligation légale :</strong> Tous les établissements de restauration commerciale du département Alpes-Maritimes (06) doivent justifier d&apos;au minimum un salarié ayant suivi la formation en hygiène alimentaire de 14 heures.
            </p>
          </div>
          <div className="prose prose-gray max-w-none text-gray-700 leading-relaxed space-y-4">
            <p>Nice, cinquième ville de France, est le cœur de la Riviera française. La cuisine niçoise — salade niçoise, socca, pissaladière, ratatouille, pan bagnat — est reconnue mondialement. Cannes, avec son festival international du film, ses palaces et ses restaurants étoilés, impose les plus hauts standards d&apos;hygiène alimentaire. Antibes, Menton et Grasse complètent ce territoire gastronomique d&apos;exception. Le tourisme de luxe et la clientèle internationale exigent une qualité irréprochable. Les DDPP renforcent les contrôles pendant la saison estivale et lors des événements majeurs (Festival de Cannes, Carnaval de Nice).</p>
            <p>La formation hygiène alimentaire dans le Alpes-Maritimes dure <strong>14 heures</strong>, conformément au décret du 24 juin 2011 modifié par l&apos;arrêté du 12 février 2024. Elle comprend désormais <strong>4 heures obligatoires de mise en pratique</strong>. Le programme aborde la réglementation européenne (paquet hygiène), les dangers alimentaires (biologiques, chimiques, physiques), les 7 principes de la méthode HACCP, le Plan de Maîtrise Sanitaire (PMS) et la gestion des allergènes.</p>
            <p>Le financement de la formation HACCP dans le Alpes-Maritimes peut être pris en charge par <strong>l&apos;OPCO AKTO</strong> pour les salariés du secteur CHR (cafés, hôtels, restaurants). Les demandeurs d&apos;emploi peuvent bénéficier d&apos;une prise en charge par <strong>France Travail</strong>. Les créateurs d&apos;entreprise peuvent mobiliser le CPF ou les aides régionales.</p>
            <p>Les services de la <strong>DDPP du Alpes-Maritimes</strong> effectuent des contrôles réguliers dans les établissements de restauration. L&apos;absence d&apos;attestation de formation HACCP lors d&apos;un contrôle peut entraîner une <strong>amende de 5e classe</strong> (jusqu&apos;à 1 500 €). Il est donc essentiel pour tout professionnel de la restauration dans le département de s&apos;assurer qu&apos;au moins un membre de son personnel détient cette attestation.</p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8">
            {[
              { label: "Restaurants dans le 06", value: "2 800+" },
      ...
      <section className="py-12 px-4 bg-gray-50">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-2xl font-bold mb-8">Questions fréquentes — Formation HACCP Alpes-Maritimes (06)</h2>
      ...
      <section className="py-12 px-4 bg-blue-700 text-white text-center">
        <div className="max-w-xl mx-auto">
          <h2 className="text-2xl font-bold mb-3">Trouver ma formation HACCP dans le Alpes-Maritimes</h2>
