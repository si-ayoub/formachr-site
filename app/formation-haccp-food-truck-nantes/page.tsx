...
export const metadata: Metadata = {
  title: "Formation HACCP Food Truck à Nantes — Hygiène Alimentaire 2026",
  description: "Formation hygiène alimentaire pour food trucks à Nantes. 14h, attestation DRAAF, financement OPCO. Devis gratuit sous 24h.",
  alternates: { canonical: `${SITE_URL}/formation-haccp-food-truck-nantes` }
}

const FAQ = [
  { question: "La formation HACCP est-elle obligatoire pour les food trucks à Nantes ?", answer: "Oui, tous les établissements de type Food Truck (code NAF 56.10C) à Nantes sont soumis à l&apos;obligation de former au minimum un salarié à l&apos;hygiène alimentaire (14h). Cette obligation est en vigueur depuis octobre 2012." },
  { question: "Combien coûte la formation HACCP Food Truck à Nantes ?", answer: "Le tarif varie entre 290€ et 490€ TTC en présentiel à Nantes. La formation peut être prise en charge à 100% par l&apos;OPCO AKTO pour les salariés du secteur ou par France Travail pour les demandeurs d&apos;emploi." },
  ...
  { question: "Peut-on suivre la formation HACCP Food Truck en ligne depuis Nantes ?", answer: "Certains organismes proposent des formations à distance. Cependant, depuis 2024, 4 heures de mise en pratique sont obligatoires. Des formules mixtes (e-learning + présentiel) existent à Nantes." },
]
  ...
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(schemaBreadcrumb([
        ...
        { name: "Formation HACCP Food Truck Nantes", url: "/formation-haccp-food-truck-nantes" }
      ])) }} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(schemaCourse({
        name: "Formation HACCP Food Truck à Nantes",
        description: "Formation hygiène alimentaire spécifique Restauration de type rapide à Nantes",
        city: "Nantes",
        price: "290",
        duration: "PT14H"
      })) }} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(schemaLocalBusiness({
        name: "Formation HACCP Food Truck Nantes",
        city: "Nantes",
        postalCode: "44000",
        lat: 47.2184,
        lng: -1.5536
      ...
      <nav className="max-w-7xl mx-auto px-4 py-3 text-sm text-gray-500">
        <ol className="flex items-center gap-2 flex-wrap">
          ...
          <li>›</li>
          <li className="text-gray-800 font-medium">Food Truck à Nantes</li>
        </ol>
      </nav>
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h1 className="text-3xl lg:text-4xl font-extrabold leading-tight mb-4">
              Formation HACCP<br />
              <span className="text-yellow-400">Food Truck à Nantes</span><br />
            ...
            <p className="text-blue-100 text-base mb-5 leading-relaxed">
              Nantes, métropole dynamique de l&apos;Ouest, fruits de mer et muscadet, impose à tous les food trucks de former au moins un salarié à l&apos;hygiène alimentaire. Trouvez la meilleure formation HACCP Food Truck près de chez vous.
            </p>
          ...
          <div><LeadForm sector="food-truck" city="Nantes" title="Devis gratuit — Food Truck Nantes" /></div>
        </div>
      </section>

      <section className="py-12 px-4 bg-white">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl font-bold mb-6">Formation HACCP Food Truck à Nantes — Ce que la loi impose</h2>
          <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-5 mb-8">
            <p className="text-yellow-900 font-medium">
              📋 <strong>Obligation légale :</strong> Tout établissement de type Restauration de type rapide (code NAF 56.10C) à Nantes doit justifier d&apos;au minimum un salarié ayant suivi la formation spécifique en matière d&apos;hygiène alimentaire de 14 heures.
            </p>
          </div>
          <div className="prose prose-gray max-w-none text-gray-700 leading-relaxed space-y-4">
            <p>À <strong>Nantes</strong>, les food trucks sont soumis à l&apos;obligation de formation en hygiène alimentaire depuis le décret du 24 juin 2011. Cette formation, communément appelée « formation HACCP », dure <strong>14 heures</strong> et doit être dispensée par un organisme agréé par la DRAAF. Elle comprend désormais <strong>4 heures de mise en pratique obligatoire</strong> depuis l&apos;arrêté du 12 février 2024.</p>
            ...
            <p>Les food trucks de Nantes font l&apos;objet de <strong>contrôles réguliers de la DDPP</strong>. L&apos;absence d&apos;attestation de formation HACCP peut entraîner une amende de 5e classe (jusqu&apos;à 1 500 €). Au-delà de l&apos;obligation légale, la formation permet de maîtriser les bonnes pratiques d&apos;hygiène essentielles à la sécurité des consommateurs.</p>
            <p>Le <strong>financement</strong> de la formation HACCP Food Truck à Nantes peut être pris en charge par l&apos;<strong>OPCO AKTO</strong> pour les salariés du secteur CHR, par <strong>France Travail</strong> pour les demandeurs d&apos;emploi, ou par le <strong>CPF</strong> et les aides régionales pour les créateurs d&apos;entreprise. Le tarif moyen à Nantes est de <strong>290 € à 490 € TTC</strong> en présentiel.</p>
      ...
      <section className="py-12 px-4 bg-gray-50">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-2xl font-bold mb-8">Questions fréquentes — HACCP Food Truck à Nantes</h2>
      ...
      <section className="py-12 px-4 bg-blue-700 text-white text-center">
        <div className="max-w-xl mx-auto">
          <h2 className="text-2xl font-bold mb-3">Formation HACCP Food Truck à Nantes</h2>
